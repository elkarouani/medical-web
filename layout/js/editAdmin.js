...
function UpdateInfoAdmin() {
    var errors = [];
    $('.alert-popup').hide();
    loaderBtn('btnUpdateInfoAdmin', 'Chargement....');
...
function UpdateLoginAdmin() {
    ...
    var errors = [];
    $('.alert-popup').hide();
    loaderBtn('btnUpdateLoginAdmin', 'Chargement....');
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data == '1') {
                loaderBtn('btnUpdateLoginAdmin', '<i class="fa fa-edit"></i> Modifier');
                showAlertSuccess('Les informations est bien modifier');
            } else if (data == '0') {
                loaderBtn('btnUpdateLoginAdmin', '<i class="fa fa-edit"></i> Modifier');
                ShowAlertError("Respecter le format de login !");
            } else {
                loaderBtn('btnUpdateInfoAdmin', '<i class="fa fa-edit"></i> Modifier');
                ShowAlertError("Respecter le format de login !");
                errors = JSON.parse(data);
...
function ChangePassAdmin() {
    ...
    var errors = [];
    $('.alert-popup').hide();
    loaderBtn('btnChangePass', 'Chargement....');
...
function UpdateImageAdmin() {
    ...
    loaderBtn('btnUpdateImageAdmin', 'Chargement....');
