<?php
    ...
    $title = 'Gestionnaires';
    $link  = 'gestionnaires';
    $subLink  = 'gestionnaires';
    $acceUser = ['admin'];
    $withLoader = false;
    include_once "includes/templates/header.inc";
    $admins = getDatas("select * from gestionnaire ", []);
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <a href="addGestionnaire.php" class="btn btn-primary"> <i class="fa fa-user-plus"></i> &nbsp; Nouveau Gestionnaire</a>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title"> <i class="fa fa-user-circle"></i> &nbsp;Liste des gestionnaires</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" id="btnRefreshGestionnaires" ><i class="fa fa-refresh"></i></button>
            ...
            <div class="box-body table-responsive">
              <table id="tblGestionnaires" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>Image</th>
                            <th>Nom</th>
            ...
            success : function(res){
                ...
                $('#tblGestionnaires').DataTable({
                    ...
                    "fnRowCallback": function (nRow, aData, iDisplayIndex)
                    {
                        ...
                        $("td:last", nRow).html(
                            '<button onclick="DeleteGestionnaire(' + aData.idGestionaire + ',' + false + ')"  id="btnDeleteGestionnaire" style="display:inline-block"  class="btn btn-danger btn-flat btn-sm">' +
                            '<i class="fa fa-trash-o"></i>' +
                            '</button>'

                            +

                            '  <a style="display:inline-block" href="editGestionnaire.php?idGestionnaire=' + aData.idGestionaire + '" class="btn btn-success btn-flat btn-sm">' +
                    ...
                    "columns": [
                        {
                            ...
                            {
                                return '<img class="img-circle" width="70" height="70" src="http://localhost/siteCabinetDentaire/admin/data/uploades/avatarGestionnaires/' + data + '" />';
                            }
                        },
                        { "data" : "nom" },
                        { "data" : "prenom" },
